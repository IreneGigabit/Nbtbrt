<%@ Control Language="C#" ClassName="Brt52FormA9Z_back" %>
...
<input type="hidden" name="d_agt_no1" id="d_agt_no1" value=""><!--預設出名代理人-->
...
<INPUT TYPE="text" id=tfzd_remark3 name=tfzd_remark3><!--dmt_temp.remark3-->
