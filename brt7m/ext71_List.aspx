...
<script runat="server">
    ...
    private void PageLayout() {
        if (modify == "U") {//追加選取
            StrFormBtnTop += "<a class=\"imgCls\" href=\"javascript:void(0);\" >[回開立請款單]</a>\n";
            //if (qs_dept == "t") {
            ...
            //StrFormBtnTop += "<a class=\"imgCls\" href=\"javascript:void(0);\" >[回查詢]</a>\n";
        }
    }
			...
			<ItemTemplate>
 		        <tr class="<%#(Container.ItemIndex+1)%2== 1 ?"sfont9":"lightbluetable3"%>">
	                <td class="whitetablebg" align="center">
                        ...
                        <input type=hidden id="receipt_<%#(Container.ItemIndex+1)%>" name="receipt_<%#(Container.ItemIndex+1)%>" value="<%#Eval("receipt")%>">
	                </td>
...
<script language="javascript" type="text/javascript">
    ...
    function formupdate(){
        ...
        var addurl="",url="";
        if ($("#qs_dept").val() == "t") {
            addurl = "Brt71_SaveItem.aspx?modify="+$("#modify").val();//新增temp檔,若modify=A要清空暫存檔
            url = "Brt71_Detail.aspx?modify=U";//請款單開立
        } else if ($("#qs_dept").val() == "e") {
            //***todo出口案
            addurl = "Ext71_SaveItem.aspx?modify="+$("#modify").val();//新增temp檔,若modify=A要清空暫存檔
            url = "Ext71_Detail.aspx?modify=U";//請款單開立
        }
        ...
        $.ajax({
            ...
            success: function (json) {
                if($("#modify").val()=="A"){
                    ...
                    //不是新增模式(使用dialog),重load明細就好.畫面不重新整理
                    window.parent.brt71item_form.reload();
