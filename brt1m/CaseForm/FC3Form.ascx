...
<TABLE border=0 class=bluetable cellspacing=1 cellpadding=2 width="100%">
	...
	<tr>
		...
		<td class=whitetablebg colspan="7"><input type="text" id="fr3_issue_no" name="fr3_issue_no" class="onoff" value="" size="20" maxlength="20" onchange="reg.tfzd_issue_no.value=this.value"></TD>
	</tr>
	<tr>
		<td class=lightbluetable align=right >商標/標章名稱：</td>
		<td class=whitetablebg colspan="7"><input type="text" id="fr3_appl_name" name="fr3_appl_name" class="onoff" value="" size="30" maxlength="100" onchange="reg.tfzd_appl_name.value=this.value"></TD>
	</tr>
	<tr>
