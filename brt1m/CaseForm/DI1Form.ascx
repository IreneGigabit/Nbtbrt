...
<TABLE border=0 class=bluetable cellspacing=1 cellpadding=2 width="100%">
	...
	<tr>
		...
		<td class="whitetablebg" colspan="7" >
		    <select id="tfp3_agt_no" NAME="tfp3_agt_no" onchange="br_form.copycase('tfp3_agt_no')"><%#tfp3_agt_no%></select>
		</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td class=whitetablebg colspan="7">
			<input type=radio name=fr3_S_Mark value="" onclick="dmt_form.change_mark(1, this)">商標
			<input type=radio name=fr3_S_Mark value="S" onclick="dmt_form.change_mark(1, this)">92年修正前服務標章
			<input type=radio name=fr3_S_Mark value="N" onclick="dmt_form.change_mark(1, this)">團體商標
			<input type=radio name=fr3_S_Mark value="M" onclick="dmt_form.change_mark(1, this)">團體標章
			<input type=radio name=fr3_S_Mark value="L" onclick="dmt_form.change_mark(1, this)">證明標章
		</TD>
	</tr>
	<tr>
		<td class=lightbluetable align=right >註冊號數：</td>
		<td class=whitetablebg colspan="3">
			<input type="text" id="fr3_issue_no" name="fr3_issue_no" value="" size="20" maxlength="20" >
		</TD>
		<td class=lightbluetable align=right width="18%">商標/標章名稱：</td>
		<td class=whitetablebg colspan="3">
			<input type="text" id="fr3_Appl_name" name="fr3_Appl_name" value="" size="30" maxlength="100" onchange="reg.tfzd_Appl_name.value=this.value">
		</TD>
	</tr>
	<tr>
		<td class=lightbluetable align=right >擬評定之類別種類：</td>
		<td class=whitetablebg colspan="3">
			<input type="radio" id=fr3_class_typeI name=fr3_class_type value="int" onclick="reg.tfzr_class_type(0).checked = reg.fr3_class_type(0).checked">國際分類
			<input type="radio" id=fr3_class_typeO name=fr3_class_type value="old" onclick="reg.tfzr_class_type(1).checked = reg.fr3_class_type(1).checked">舊類
		</TD>
