<%@ Control Language="C#" ClassName="apcust_FC_RE_form" %>
...
<script type="text/html" id="apcust_fc_re_template">
	...
	<TR>
		...
		<TD class=whitetablebg title="輸入關鍵字並點選申請人查詢，即顯示申請人資料清單。">
		    申請人名稱(中)：
		    <INPUT TYPE=text id=dbmn_ncname1_## NAME=dbmn_ncname1_## SIZE=30 alt='『申請人名稱(中)』' MAXLENGTH=60 onblur="fDataLen(this)">
		    <INPUT TYPE=text id=dbmn_ncname2_## NAME=dbmn_ncname2_## SIZE=30 alt='『申請人名稱(中)』' MAXLENGTH=60 onblur="fDataLen(this)">
