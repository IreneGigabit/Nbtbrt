<%@ Control Language="C#" ClassName="br_A1_form_back" %>
...
<TABLE border=0 class=bluetable cellspacing=1 cellpadding=2 width="100%">
	...
	<tr>
		...
		<td class="whitetablebg" colspan=7><input TYPE="text"  NAME="tfz1_Appl_name" alt="『商標名稱』" SIZE="60" MAXLENGTH="100" onblur="vbscript:appl_name_onblur me.value,me.maxlength,me.alt">
