<%@ Control Language="C#" ClassName="FA1_form_remark1" %>
...
<input type="text" name="tfz1_remark1">
<input type="text" name="tfz2_remark1">
<input type="text" name="tfz3_remark1">
<input type="text" name="tfz4_remark1">
<div id="tran_remark1"></div>

<script type="text/html" id="tran_remark1_fa1">
	...
	<tr>
		...
		<td class="whitetablebg" colspan="7">優先權證明文件(<input TYPE="checkbox" NAME="tt11_Z2C" value="Z2C" onclick="tran_remark1_form.CopyStr(reg.tfz1_remark1)">附中文譯本)。</td>
	</tr>
	...
	<tr>
		...
		<td class="whitetablebg" colspan="7">展覽會優先權證明文件(<input TYPE="checkbox" NAME="tt11_Z31C" value="Z31C" onclick="tran_remark1_form.CopyStr(reg.tfz1_remark1)">附中文譯本)。</td>
	</tr>
	<tr>
		...
		<td class="whitetablebg" colspan="7">委任書(<input TYPE="checkbox" NAME="tt11_Z4C" value="Z4C" onclick="tran_remark1_form.CopyStr(reg.tfz1_remark1)">附中文譯本)。</td>
	</tr>
...
<script type="text/html" id="tran_remark1_fa5">
...
<script type="text/html" id="tran_remark1_fad">
...
<script type="text/html" id="tran_remark1_fa9">
...
<!------->
<script type="text/html" id="tran_remark1_fa2">
...
<script type="text/html" id="tran_remark1_fa6">
...
<script type="text/html" id="tran_remark1_faa">
...
<script type="text/html" id="tran_remark1_fae">
...
<!------->
<script type="text/html" id="tran_remark1_fa3">
...
<script type="text/html" id="tran_remark1_fa7">
...
<script type="text/html" id="tran_remark1_fab">
...
<script type="text/html" id="tran_remark1_faf">
...
<!------->
<script type="text/html" id="tran_remark1_fa4">
...
<script type="text/html" id="tran_remark1_fa8">
...
<script type="text/html" id="tran_remark1_fac">
...
<script type="text/html" id="tran_remark1_fag">
...
<script type="text/html" id="tran_remark1_fai">
...
<script type="text/html" id="tran_remark1_faj">
...
<script type="text/html" id="tran_remark1_fak">
