...
<script runat="server">
	...
	protected void WordOut() {
        string docFileName = "[廢止再授權]-" + ipoRpt.Seq + ".docx";

		Dictionary<string, string> _tplFile = new Dictionary<string, string>(){
			{"apply", Server.MapPath("~/ReportTemplate/申請書/404廢止再授權登記申請書FL4.docx")},
		...
		if (dmt.Rows.Count > 0) {
            ...
            if (dmt.Rows[0]["mark"].ToString()=="A"){
                ...
                ipoRpt.ReplaceBookmark("mark", "授權人(原再授權登記案之授權人)");
            ...
            mapList.Add(new AttachMapping { brColValue = remark1, mapValue = "Z1", docType = "E70" });//再授權契約書
            mapList.Add(new AttachMapping { brColValue = remark1, mapValue = "Z1C", docType = "E71" });//再授權契約書中文譯本
