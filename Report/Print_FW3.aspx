...
<script runat="server">
	...
	protected void WordOut() {
        string docFileName = "[商標權拋棄]-" + ipoRpt.Seq + ".docx";
		
		Dictionary<string, string> _tplFile = new Dictionary<string, string>(){
			{"apply", Server.MapPath("~/ReportTemplate/申請書/610[商簡A]商標權拋棄申請書FW3.docx")},
		...
		if (dmt.Rows.Count > 0) {
            ...
            ipoRpt.ReplaceBookmark("con_issue_no", dmt.Rows[0]["issue_no"].ToString().Trim());
