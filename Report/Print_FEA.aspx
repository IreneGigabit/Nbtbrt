...
<script runat="server">
	...
	protected void WordOut() {
		string docFileName = "[顏色團體標章註冊]-" + ipoRpt.Seq + ".docx";
		
		Dictionary<string, string> _tplFile = new Dictionary<string, string>(){
			{"apply", Server.MapPath("~/ReportTemplate/申請書/206顏色團體標章註冊申請書FEA.docx")},
		...
		if (dmt.Rows.Count > 0) {
			...
			switch (dmt.Rows[0]["remark3"].ToString().Trim()) {
				case "相關物品":
					ipoRpt.ReplaceBookmark("draw_mark3", "虛線部分之相關物品之形狀屬於標章之一部分");
					break;
				case "文書":
					ipoRpt.ReplaceBookmark("draw_mark3", "虛線部分之相關文書之形狀屬於標章之一部分");
					break;
				default:
