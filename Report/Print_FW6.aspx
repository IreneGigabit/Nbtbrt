...
<script runat="server">
	...
	protected void WordOut() {
        string docFileName = "[撤回]-" + ipoRpt.Seq + ".docx";
		
		Dictionary<string, string> _tplFile = new Dictionary<string, string>(){
			{"apply", Server.MapPath("~/ReportTemplate/申請書/603[商簡A]廢止案撤回申請書FW6.docx")},
		...
		if (dmt.Rows.Count > 0) {
            ...
            //原預帶:申請撤回針對註冊號第#con_apply_no#號「#con_appl_name#」#con_s_mark#提出之廢止申請案(貴局收文文號_________)。
            //測試後反應依交辦內容顯示
            ipoRpt.ReplaceBookmark("con_apply_no", con_apply_no);
            ipoRpt.ReplaceBookmark("con_appl_name", dmt.Rows[0]["appl_name"].ToString().ToXmlUnicode());
            ipoRpt.ReplaceBookmark("con_s_mark", dmt.Rows[0]["s_marknm"].ToString());
