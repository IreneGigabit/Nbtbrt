...
<script runat="server">
    ...
    protected void Page_Load(object sender, EventArgs e) {
        ...
        Response.Write(",\"dmt_temp1\":" + JsonConvert.SerializeObject(GetDmtTempSub(ref dtCaseTemp1), settings).ToUnicode() + "\n");//一案多件(分割).dmt_temp子案
    ...
    private DataTable GetCaseAttach(ref DataTable dt) {
        if (in_no != "") {
            ...
            //conn.DataTable(SQL, dt);
            dt = Sys.GetDmtAttach(conn, in_no);
    ...
    #region GetDmtTempSub 一案多件.dmt_temp子案
    private DataTable GetDmtTempSub(ref DataTable dt) {
