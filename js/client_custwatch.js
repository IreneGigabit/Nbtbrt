...
function check_CustWatch(pchk,pvalue){
    ...
    if (pchk=="cappl_name" || pchk=="appl_name"){
        if (pvalue!=""){
            if (check_ctrl_keydata("<%=Session["SeBranch"]%>","cappl_name",pvalue) == "A"){//A:不可立案,B:提醒
                return true;
            }
        }
    }
    if (pchk=="eappl_name" || pchk=="appl_name"){
        if (pvalue!=""){
            if (check_ctrl_keydata("<%=Session["SeBranch"]%>","eappl_name",pvalue) == "A"){//A:不可立案,B:提醒
                return true;
            }
        }
    }
    if (pchk=="cappl_name" || pchk=="appl_name"){
        if (pvalue!=""){
            if (check_ctrl_keydata("<%=Session["SeBranch"]%>",pchk,pvalue) == "A"){//A:不可立案,B:提醒
                return true;
            }
        }
    }
