...
<script runat="server">
    protected string HTProgCap = "申請人委任書管理";//HttpContext.Current.Request["prgname"];//功能名稱
...
<script language="javascript" type="text/javascript">
    ...
    $("#btnSrch").click(function (e) {
        ...
        if (NulltoEmpty($("#qryapcust_no").val()) == "" && NulltoEmpty($("#qrycontract_nos").val()) == "" && NulltoEmpty($("#qrycontract_noe").val()) == "" 
            && NulltoEmpty($("#qrycontract_sdate").val()) == "" && NulltoEmpty($("#qrycontract_edate").val()) == "" && NulltoEmpty($("#qryuse_date").val()) == ""
            && NulltoEmpty($("#qryap_cname").val()) == "" && NulltoEmpty($("#qryap_ename").val()) == ""
            && NulltoEmpty($("#qryscode").val()) == "") {
            alert("請輸入「申請人編號」、「接洽人員」、「委任書號碼」、「簽約期間」及「到期日期」任一條件");
            return false;
        }
        ...
        reg.action = "cust22_List.aspx?prgid=<%=prgid%>";
        reg.submit();
