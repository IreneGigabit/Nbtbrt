        ...
        for (int i = 0; i < page.pagedTable.Rows.Count; i++) {
            ...
            if (dr.SafeRead("custtype", "") == "1") {
                ...
                if ((HTProgRight & 128) != 0) {
                    dr["thref"] = Page.ResolveUrl("~/cust/cust11_edit.aspx") + "?modify=Q&submitTask=Q&gs_dept=" + Session["dept"] + "&cust_area=" + dr["cust_area"] + "&cust_seq=" + dr["cust_seq"] + "&apsqlno=" + dr["apsqlno"] + "&hRight=3&prgid=cust46";
                }
            } else {
                dr["custtypename"] = "申請人";
                //**todo
                if ((HTProgRight & 128) != 0) {
                    dr["thref"] = Page.ResolveUrl("~/cust/cust13_edit.aspx") + "?apsqlno=" + dr["apsqlno"] + "&modify=Q&hRight=3&prgid=cust46&cust_area=" + dr["cust_area"];
                }
            }
        }
...
<form style="margin:0;" id="regPage" name="regPage" method="post">
    <%#page.GetHiddenText("GoPage,PerPage,SetOrder,chktest,FromQuery")%>
