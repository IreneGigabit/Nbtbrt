...
<script runat="server">
    protected string HTProgCap = "確認轉案簽核(轉入)";//HttpContext.Current.Request["prgname"];//功能名稱
    ...
    private void PageLayout() {
        ...
        using (DBHelper conn = new DBHelper(Conn.btbrt).Debug(false)) {
            ...
            if ((HTProgRight & 256) != 0) {
                ...
                SQL += "where a.job_status='NN' and  (a.dowhat='TRAN_EM') and a.syscode='" + Session["syscode"] + "' and a.apcode='" + apcode + "' ";
        ...
        <table id="qryForm" border="0" class="bluetable" cellspacing="1" cellpadding="2" width="70%" align="center">	
            <tr>
		        ...
		        <td class="whitetablebg" align="left">
                    <select id='job_scode' name='job_scode' onchange="searchScode(this.value,'from_scode','trant')" >
                        <%#td_jscode%>
                    </select>
                </td>
	        </tr>
