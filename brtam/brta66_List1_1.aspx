...
<script runat="server">
    protected string HTProgCap = "內商承辦工作量統計-清單";//HttpContext.Current.Request["prgname"];//功能名稱
    ...
    private void QueryData() {
        ...
        //2006/8/28配合爭救案系統，區所自行發文者才列入承辦量統計
        SQL += " and a.opt_branch='" + Session["seBranch"] + "' ";
        ...
        if (ReqVal.TryGet("pr_scode") != "") {
            SQL += "AND a.pr_scode='" + ReqVal["pr_scode"] + "' ";
        }
        if (ReqVal.TryGet("qty_type") != "") {
            SQL += "AND b.qty_type like '" + ReqVal["qty_type"] + "%' ";
        }
