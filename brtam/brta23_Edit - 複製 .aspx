...
<script runat="server">
    ...
    private void QueryData() {
        ...
        Response.Write(",\"add_ctrl\":" + JsonConvert.SerializeObject(add_ctrl, settings).ToUnicode() + "\n");//交辦官發預設值
        Response.Write("}");
        Response.End();
    }
</script>
...
<script language="javascript" type="text/javascript">
    ...
    function this_init() {
        ...
        $.ajax({
            type: "get",
            url: "brta23_edit.aspx?json=Y&<%#Request.QueryString%>&<%#Request.Form.ParseQueryString()%>",
