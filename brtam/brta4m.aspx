    ...
    <div id="id-div-slide">
        <table id="qryForm" border="0" class="bluetable" cellspacing="1" cellpadding="2" width="90%" align="center">	
	        ...
	        <tr id="tr_in_date">
		        ...
		        <td class="whitetablebg" align="left" colspan=3>
			        <input type="text" id="isdate" name="isdate" size="10" class="dateField" onblur="ChkDat(this)">～
			        <input type="text" id="iedate" name="iedate" size="10" class="dateField" onblur="ChkDat(this)">
		        </td>
	        </tr>
	        <tr id="tr_cust">
