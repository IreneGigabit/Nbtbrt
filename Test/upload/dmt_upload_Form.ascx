<%@ Control Language="C#" ClassName="dmt_upload_form_test" %>
...
<TABLE id='tabfile<%#uploadfield%>' border=0 class="bluetable" cellspacing=1 cellpadding=2 width="100%">
    ...
    <TR>
		<TD class=whitetablebg align=center colspan=5>
			...
			<!--input type="button" value ="增加一筆" class="cbutton " id=file_Add_button name=file_Add_button onclick="upload_form.appendFile()"-->
			<input type="button" value ="減少一筆" class="cbutton" id=file_Del_button name=file_Del_button onclick="upload_form.deleteFile()">
		</TD>
	</TR>
    </thead>
    <script type="text/html" id="upload_template"><!--文件上傳樣板-->
		<TR class="tr_brattach_##">
			...
			<TD class=sfont9 colspan="2" align="left">
                ...
                <input type=button id='btn<%#uploadfield%>_##' name='btn<%#uploadfield%>_##' class='cbutton' value='上傳' onclick="upload_form.UploadAttach('##')">
                <input type=button id='btn<%#uploadfield%>_D_##' name='btn<%#uploadfield%>_D_##' class='cbutton' value='刪除' onclick="upload_form.DelAttach('##')">
                ...
                <br>檔案說明：<select id='doc_type_##' name='doc_type_##' onchange="upload_form.getfiledoc('##')"><%#html_doc%></select>
                <input type=text id='<%#uploadfield%>_desc_##' name='<%#uploadfield%>_desc_##' size=50 maxlength=60 onblur="fChkDataLen(this,'檔案說明')" >
                <label id="span_branch_##" style="display:none"><input type=checkbox id='<%#uploadfield%>_branch_##' name='<%#uploadfield%>_branch_##' value='B'><font color='blue'>交辦專案室</font></label>
                <label id="span_edoc_##" style="display:none"><input type=checkbox id='doc_flag_##' name='doc_flag_##' value='E'><font color='blue'>電子送件文件檔(pdf)</font></label>
			</TD>
		</TR>
    </script>
    <tbody></tbody>
