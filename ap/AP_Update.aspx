...
<script runat="server">
    ...
    private void doAdd(DBHelper cnn) {
        ...
        SQL += "," + Util.dbnull(Request["pfx_APcode"]) + "";
        SQL += "," + Util.dbnull(Request["tfx_APnameC"]) + "";
        SQL += "," + Util.dbnull(Request["tfx_APnameE"]) + "";
        SQL += "," + Util.dbnull(Request["tfx_APcat"]) + "";
        SQL += "," + Util.dbnull(Request["tfx_APserver"]) + "";
        SQL += "," + Util.dbnull(Request["tfx_APpath"]) + "";
        SQL += "," + Util.dbnull(Request["tfx_ReMark"]) + "";
        SQL += "," + Util.dbnull(Request["tfx_APorder"]) + "";
        SQL += "," + Util.dbnull(Request["tfx_APGrpClass"]) + "";
        SQL += "," + Util.dbnull(Request["nfx_end_level"]) + "";
    ...
    private void doUpdate(DBHelper cnn) {
        SQL = " Update AP set";
        SQL += " APnameC = " + Util.dbnull(Request["tfx_APnameC"]) + "";
        SQL += ",APnameE = " + Util.dbnull(Request["tfx_APnameE"]) + "";
        SQL += ",APcat = " + Util.dbnull(Request["tfx_APcat"]) + "";
        SQL += ",APserver = " + Util.dbnull(Request["tfx_APserver"]) + "";
        SQL += ",APpath = " + Util.dbnull(Request["tfx_APpath"]) + "";
        SQL += ",ReMark = " + Util.dbnull(Request["tfx_ReMark"]) + "";
        SQL += ",APorder = " + Util.dbnull(Request["tfx_APorder"]) + "";
        SQL += ",APGrpClass = " + Util.dbnull(Request["tfx_APGrpClass"]) + "";
        SQL += ",end_level = " + Util.dbnull(Request["nfx_end_level"]) + "";
